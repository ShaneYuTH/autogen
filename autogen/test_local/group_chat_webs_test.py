...
# After last round, the manager will select user proxy and it will receive the last message from history, 
# then generate the exit prompt(final, reply = reply_func(self, messages=messages, sender=sender, config=reply_func_tuple["config"])).